...
import kotlinx.android.synthetic.main.layout_success_dialog_paypr.*

class PayprSuccessDialog(context: Context, private val header: String, private val message: String,
                         private val btnText: String = "", private val isDecoratedMessage: Boolean = false,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.layout_success_dialog_paypr)
        setCancelable(false)
        ...
        if (isDecoratedMessage)
            tvSubjectSD.text = HtmlCompat.fromHtml(message, HtmlCompat.FROM_HTML_MODE_LEGACY)
        else
